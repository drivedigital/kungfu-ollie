...
/**
 * DOG — new fighter for the Kyoto Coliseum build.
 * These four moves are the authoritative durations/hit windows for the skinned dog bindings in
 * `src/game/skinned/bindings.ts`; the imported clips are retimed *to these numbers*, never the
 * other way round. Fast, light, mixup-heavy: a rushdown foil to King Croak's grab game.
 */
const dog: FighterConfig = {
  id: "dog",
  name: "RONIN",
  title: "Kyoto Street Duelist · Paws of the Rising Sun",
  maxHp: 102,
  walkSpeed: 4.1,
  backSpeed: 3.1,
  jumpVel: 11.8,
  ...
  color: "#ffb45e",
  colorHex: 0xffb45e,
  stats: { speed: 5, power: 4, tough: 2, icon: "🐕" },
  moveNames: { light: "Paw Jab", heavy: "Martelo Kick", special: "Whirlwind Axes", air: "Twist Flip Dive" },
  moves: {
    light: {
      slot: "light",
      name: "Paw Jab",
      duration: 0.4,
      hits: [{ start: 0.11, end: 0.19, damage: 5, reach: 1.6, band: "high", knockback: 3.2, hitstun: 0.32, blockstun: 0.16, shake: 0.12, hitstop: 0.04 }],
      meterGain: 7,
      cancel: { start: 0.17, end: 0.38 },
      fx: "jab",
      lunge: { start: 0.08, end: 0.16, speed: 2.8 },
    },
    heavy: {
      slot: "heavy",
      name: "Martelo Kick",
      duration: 0.85,
      hits: [{ start: 0.27, end: 0.4, damage: 12, reach: 2.0, band: "mid", knockback: 6, launch: 9, hitstun: 0.66, blockstun: 0.32, shake: 0.4, hitstop: 0.1 }],
      meterGain: 10,
      fx: "kick",
      lunge: { start: 0.2, end: 0.3, speed: 4.2 },
    },
    special: {
      slot: "special",
      name: "Whirlwind Axes",
      duration: 1.3,
      // two contact windows: the first sweep and the finishing spin
      hits: [
        { start: 0.34, end: 0.52, damage: 8, reach: 1.9, band: "mid", knockback: 3, hitstun: 0.4, blockstun: 0.24, shake: 0.3, hitstop: 0.06 },
        { start: 0.62, end: 0.86, damage: 14, reach: 2.15, band: "mid", knockback: 10, launch: 7, hitstun: 0.8, blockstun: 0.45, shake: 0.65, hitstop: 0.12 },
      ],
      meterCost: 50,
      meterGain: 0,
      lunge: { start: 0.3, end: 0.9, speed: 6.2, stopOnHit: false },
      fx: "spin",
      fireAt: 0.34,
    },
    air: {
      slot: "air",
      name: "Twist Flip Dive",
      duration: 0.7,
      hits: [{ start: 0.12, end: 0.5, damage: 10, reach: 1.55, band: "mid", knockback: 5, launch: 3.5, hitstun: 0.45, blockstun: 0.25, shake: 0.3, hitstop: 0.08 }],
      meterGain: 7,
      fx: "fang",
      impulse: { x: 5, y: -7.5 },
    },
...
/** Roster order used by the select screen and the leaderboard. */
export const FIGHTER_IDS: CharId[] = ["chicken", "buffalo", "ewe", "toad", "dog"];
