 ...
 *   dog   light 0.40 hit 0.11-0.19 | heavy 0.85 hit 0.27-0.40
 *         special 1.30 hits 0.34-0.52 + 0.62-0.86 | air 0.70 hit 0.12-0.50
 */
...
export const DOG_BINDING: SkinnedBinding = {
  ...
  states: {
    ...
    light: { clip: "Punching Bag", trim: [0, 0.5], fit: 0.4, loop: false, holdLast: true, fade: 0.05, rootY: "strip", note: "Single jab selected and retimed to 0.40s; contact inside 0.11-0.19." },
    heavy: { clip: "Martelo 2", trim: [0, 1.15], fit: 0.85, loop: false, holdLast: true, fade: 0.07, rootY: "strip", note: "Martelo kick retimed to 0.85s; contact inside 0.27-0.40." },
    special: { clip: "Dual Weapon Combo", fit: 1.3, loop: false, holdLast: true, fade: 0.06, rootY: "strip", overlay: "axes", note: "Axes equipped as props for this action only; both hit windows covered." },
    ...
    intro: { clip: "Boxing", trim: [0, 1.1], speed: 0.75, loop: false, holdLast: true, fade: 0.12, rootY: "strip", overlay: "bow", note: "Authored bow into guard; Skinning Test is diagnostic only." },
  },
};
